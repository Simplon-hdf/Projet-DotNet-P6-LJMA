...
namespace Projet_DotNet_P6_LJMA.Repositories
{
    public class PostPhiloRepository : IPostPhiloRepository
    {
        ...
        public async IAsyncEnumerable<Post_philo> GetAllAsync()
        {
        ...
        public async Task<Post_philo?> GetByIdAsync(string id)
        {
            return await _context.PostPhilos.FindAsync(id);
        }

        public async Task CreateAsync(Post_philo post_philo)
        {
            _context.Add(post_philo);
            await _context.SaveChangesAsync();
        }

        public async Task UpdateAsync(Post_philo post_philo)
        {
